      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8">
        {items.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-2xl font-bold text-[#1A2A44] mb-2">Your Cart is Empty</h2>
            <p className="text-[#94A3B8] mb-8">Looks like you haven't added any products yet.</p>
            <Link
              to="/shop"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[#D4AF37] to-[#B8960F] text-[#1A2A44] font-bold rounded-xl hover:shadow-lg transition-all"
            >
              Start Shopping
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 space-y-4">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <Link to={`/product/${item.product?.slug}`}>
                        <h3 className="font-semibold text-[#1A2A44] hover:text-[#D4AF37] transition-colors line-clamp-1">
                          {item.product?.name}
                        </h3>
                      </Link>
                    ...
                    <div className="text-right flex-shrink-0">
                      <p className="font-bold text-[#1A2A44]">SAR {itemTotal.toFixed(2)}</p>
                    </div>
                  </div>
                );
              })}
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-semibold text-[#1A2A44]">
            ...
            <div className="lg:w-96 flex-shrink-0">
              <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
                <h3 className="text-lg font-bold text-[#1A2A44] mb-6">Order Summary</h3>
                ...
                <div className="flex gap-2 mb-6">
                  ...
                  <button className="px-4 py-2.5 bg-[#1A2A44] text-white text-sm font-semibold rounded-lg hover:bg-[#0F172A] transition-colors">
                    Apply
                  </button>
                </div>
                ...
                <button
                  ...
                  className="w-full py-4 bg-gradient-to-r from-[#D4AF37] to-[#B8960F] text-[#1A2A44] font-bold rounded-xl shadow-[0_4px_20px_rgba(212,175,55,0.3)] hover:shadow-[0_6px_30px_rgba(212,175,55,0.5)] hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
                >
                  Proceed to Checkout
                  <ArrowRight className="w-5 h-5" />
                </button>
                <Link
                  to="/shop"
                  className="block text-center mt-4 text-sm text-[#64748B] hover:text-[#1A2A44] transition-colors"
                >
                  Continue Shopping
                </Link>
              </div>
