...
const translations: Record<string, Record<Lang, string>> = {
  ...
  heroDesc: {
    en: "Egypt's trusted destination for premium electronics. From flagship smartphones to cutting-edge laptops.",
    ar: "وجهتك الموثوقة في مصر للإلكترونيات المتميزة. من أفضل الهواتف الذكية إلى أحدث الحاسبات المحمولة.",
  },
  ...
  saveEGP: { en: "Save EGP", ar: "وفّر جنيه" },
